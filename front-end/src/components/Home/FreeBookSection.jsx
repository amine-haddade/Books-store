...
import book1 from '../../assets/explore1.png'
import book2 from '../../assets/explore2.png'
  ...
  return (
    <div className='grid md:grid-cols-2 justify-center items-center gap-6 py-10 px-16 dark:text-white '>
       <div className='flex md:w-1/2  justify-center md:justify-normal     '>
            ...
            <img src={book2} alt=""  className='object-cover w-28 md:w-52 h-full rotate-6 shadow-lg '/>
       </div>
